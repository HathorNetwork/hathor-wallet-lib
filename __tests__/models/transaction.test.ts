...
const compareTxs = (tx, tx2) => {
  ...
  expect(tx2.token_info_version).toBe(tx.token_info_version);
...
test('New tx', () => {
  ...
  const expectedDataToSignHex =
    '';
  const dataToSign = tx.getDataToSign();
  expect(dataToSign.toString('hex')).toBe(expectedDataToSignHex);

  const expectedDataToSignHashHex =
    '7f64ee571280f1168173a8c27248bc3da51c6a20c27f2c8350476bfa72551adf';
  ...
  const expectedTxHex =
    '';
...
test('Invalid token info version tx', () => {
  // Arrange
  const invalidVersion = 99 as TokenInfoVersion;
  const network = new Network('testnet');
  const tx = new CreateTokenTransaction('Test', 'TST', [], [], {
...
test('Transaction type', () => {
  ...
  const tx2 = new Transaction(inputs2, outputs2, {
    version: 1,
...
test('Known transactions hash', () => {
  ...
  const rawTx =
    '';
  ...
  const rawTxCreation =
    '';
  ...
  const rawBigTx =
    '';
