...
test('Signed', () => {
  const serializer = new Serializer();
  expect(serializer.fromSigned([0x74, 0x65, 0x73, 0x74], 300, 'int').equals(Buffer.from([0x00, 0x04, 0x00, 0x00, 0x01, 0x2c, 0x74, 0x65, 0x73, 0x74]))).toBe(true);

  expect(serializer.fromSigned([0x74, 0x65, 0x73, 0x74], 'test', 'str').equals(Buffer.from([0x00, 0x04, 0x74, 0x65, 0x73, 0x74, 0x74, 0x65, 0x73, 0x74]))).toBe(true);

  expect(serializer.fromSigned([0x74, 0x65, 0x73, 0x74], [0x74, 0x65, 0x73, 0x74], 'bytes').equals(Buffer.from([0x00, 0x04, 0x74, 0x65, 0x73, 0x74, 0x74, 0x65, 0x73, 0x74]))).toBe(true);

  expect(serializer.fromSigned([0x74, 0x65, 0x73, 0x74], 10.32134, 'float').equals(Buffer.from([0x00, 0x08, 0x40, 0x24, 0xa4, 0x86, 0xad, 0x2d, 0xcb, 0x14, 0x74, 0x65, 0x73, 0x74]))).toBe(true);

  expect(serializer.fromSigned([0x74, 0x65, 0x73, 0x74], false, 'bool').equals(Buffer.from([0x00, 0x01, 0x00, 0x74, 0x65, 0x73, 0x74]))).toBe(true);
  expect(serializer.fromSigned([0x74, 0x65, 0x73, 0x74], true, 'bool').equals(Buffer.from([0x00, 0x01, 0x01, 0x74, 0x65, 0x73, 0x74]))).toBe(true);
})
