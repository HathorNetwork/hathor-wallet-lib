...
exports.SENTRY_DSN = exports.TX_COUNT = exports.DASHBOARD_TX_COUNT = exports.DASHBOARD_BLOCKS_COUNT = exports.NETWORK = exports.P2SH_BYTE = exports.P2PKH_BYTE = exports.DEBUG_LOCAL_DATA_KEYS = exports.HATHOR_TOKEN_INDEX = exports.HATHOR_TOKEN_CONFIG = exports.TOKEN_MELT_MASK = exports.TOKEN_MINT_MASK = exports.TOKEN_CREATION_MASK = exports.TOKEN_AUTHORITY_MASK = exports.TOKEN_INDEX_MASK = exports.PASSWORD_PATTERN = exports.CONFIRM_RESET_MESSAGE = exports.HD_WALLET_ENTROPY = exports.WORDS_VALIDATION = exports.MAX_GRAPH_LEVEL = exports.MAX_OUTPUT_VALUE = exports.MAX_OUTPUT_VALUE_32 = exports.DEFAULT_TX_VERSION = exports.DEFAULT_SERVER = exports.DEFAULT_SERVERS = exports.HATHOR_BIP44_CODE = exports.LIMIT_ADDRESS_GENERATION = exports.FIRST_WALLET_COMPATIBLE_VERSION = exports.MIN_API_VERSION = exports.VERSION = exports.GAP_LIMIT = exports.GENESIS_TX = exports.GENESIS_BLOCK = exports.DECIMAL_PLACES = exports.WALLET_HISTORY_COUNT = undefined;
 ...
 */
var WALLET_HISTORY_COUNT = exports.WALLET_HISTORY_COUNT = 10;
 ...
 */
var GENESIS_BLOCK = exports.GENESIS_BLOCK = ['000000a0f82cfee5431e03b071364970861ffa1b0633f73ca7f462987ec34195'];

/**
 * ID of the genesis transactions
 */
var GENESIS_TX = exports.GENESIS_TX = ['000000831cff82fa730cbdf8640fae6c130aab1681336e2f8574e314a5533849', '0000001df6f77892cd562a2d7829bc17d0130546edfc6a81e0a431af4b8aa51e'];
 ...
 * Wallet version
 */
var VERSION = exports.VERSION = '0.6.3-beta';
 ...
 */
var FIRST_WALLET_COMPATIBLE_VERSION = exports.FIRST_WALLET_COMPATIBLE_VERSION = '0.5.0-beta';
 ...
 */
var DEFAULT_SERVERS = exports.DEFAULT_SERVERS = ['https://node2.testnet.hathor.network/api/', 'https://node3.testnet.hathor.network/api/', 'https://node17.testnet.hathor.network/api/', 'http://localhost:8080/'];
 ...
 */
var MAX_GRAPH_LEVEL = exports.MAX_GRAPH_LEVEL = 1;

/**
 * How many words will be used to validate the backup
 */
var WORDS_VALIDATION = exports.WORDS_VALIDATION = 6;
 ...
 */
var CONFIRM_RESET_MESSAGE = exports.CONFIRM_RESET_MESSAGE = 'I want to reset my wallet';
 ...
 */
var PASSWORD_PATTERN = exports.PASSWORD_PATTERN = "(?=^.{8,}$)(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*]).*$";
 ...
 */
var DEBUG_LOCAL_DATA_KEYS = exports.DEBUG_LOCAL_DATA_KEYS = ['wallet:server', 'wallet:tokens', 'wallet:started', 'wallet:backup', 'wallet:locked', 'wallet:closed', 'wallet:lastSharedIndex', 'wallet:lastGeneratedIndex', 'wallet:lastUsedIndex', 'wallet:lastUsedAddress', 'wallet:address'];
...
var currentNetwork = process.env.HATHOR_WALLET_NETWORK || 'mainnet';
 ...
 */
var DASHBOARD_BLOCKS_COUNT = exports.DASHBOARD_BLOCKS_COUNT = 6;

/**
 * Quantity of transactions to show per page in the dashboard
 */
var DASHBOARD_TX_COUNT = exports.DASHBOARD_TX_COUNT = 6;

/**
 * Quantity of elements to show per page in the transactions/blocks list
 */
var TX_COUNT = exports.TX_COUNT = 10;

/**
 * Sentry connection DSN
 */
var SENTRY_DSN = exports.SENTRY_DSN = process.env.SENTRY_DSN || 'https://69c067d1587c465cac836eaf25467ce1@sentry.io/1410476';