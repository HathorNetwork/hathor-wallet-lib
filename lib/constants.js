...
export const GENESIS_BLOCK = ['000164e1e7ec7700a18750f9f50a1a9b63f6c7268637c072ae9ee181e58eb01b'];
/**
 * ID of the genesis transactions
 */

export const GENESIS_TX = ['00029b7f8051f6ebdc0338d02d4a8cfbd662500ee03224bbee75a6f2da0350b0', '0001e887c7b5ec3b4e57033d849a80d8bccbe3a749abfa87cc31c663530f3f4e'];
/**
...
export const DEFAULT_SERVERS = ['https://node1.alpha.testnet.hathor.network/v1a/', 'https://node2.alpha.testnet.hathor.network/v1a/', 'https://node3.alpha.testnet.hathor.network/v1a/', 'https://node4.alpha.testnet.hathor.network/v1a/'];
/**
...
export const HATHOR_TOKEN_INDEX = 0; // Version bytes for address generation
