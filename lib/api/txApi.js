...
const txApi = {
  ...
  getTransactionBase(data, resolve) {
    return createRequestInstance(resolve).get(`transaction`, {
      params: data
    }).then(res => {
      resolve(res.data);
    }, res => {
  ...
  getConfirmationData(id, resolve) {
    ...
    return createRequestInstance(resolve).get(`transaction_acc_weight`, {
      params: data
    }).then(res => {
      resolve(res.data);
    }, res => {
  ...
  decodeTx(hex_tx, resolve) {
    ...
    return createRequestInstance(resolve).get(`decode_tx`, {
      params: data
    }).then(res => {
      resolve(res.data);
    }, res => {
  ...
  pushTx(hex_tx, force, resolve) {
    ...
    return createRequestInstance(resolve).get(`push_tx`, {
      params: data
    }).then(res => {
      resolve(res.data);
    }, res => {
  ...
  getDashboardTx(block, tx, resolve) {
    ...
    return createRequestInstance(resolve).get(`dashboard_tx`, {
      params: data
    }).then(res => {
      resolve(res.data);
    }, res => {
