...
class Serializer {
   ...
   * @inner
   */
  pushLenValue(buf, len) {
    buf.push((0, _buffer.intToBytes)(len, SERIALIZATION_SIZE_LEN));
  }
   ...
   */
  fromInt(value) {
    return (0, _buffer.signedIntToBytes)(value, 4);
  }
  ...
  fromAmount(value) {
    ...
    return (0, _buffer.bigIntToBytes)(value, 4);
  }
   ...
   */
  fromFloat(value) {
    return (0, _buffer.floatToBytes)(value, 8);
  }
