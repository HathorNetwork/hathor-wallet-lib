...
class HathorWallet extends EventEmitter {
  ...
  * getAllUtxos(options = {}) {
  ...
  async prepareCreateNewToken(name, symbol, amount, options = {}) {
    ...
    if (newOptions.createMint && newOptions.mintAuthorityAddress && !newOptions.allowExternalMintAuthorityAddress) {
    ...
    if (newOptions.createMelt && newOptions.meltAuthorityAddress && !newOptions.allowExternalMeltAuthorityAddress) {
