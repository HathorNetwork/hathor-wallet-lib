...
class CreateTokenTransaction extends Transaction {
  ...
  tokenInfoVersion: TokenInfoVersion | null | undefined; // null to allow creating a default instance of the class
  ...
  constructor(
    ...
    this.name = name;
    this.symbol = symbol;
    this.tokenInfoVersion = newOptions.tokenInfoVersion;
  }
